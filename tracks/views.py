...
class AddSong(CreateView, LoginRequiredMixin):
    ...
    # urlparse('https://open.spotify.com/')
    urlsplit('https://open.spotify.com/')
    urljoin('https://open.spotify.com/', 'embed/track/')
    print(urlparse('https://open.spotify.com/'))
    print(urlsplit('https://open.spotify.com/'))
